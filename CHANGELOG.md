...
- Display Antigravity as the UI agent name and preserve Antigravity model name casing
- Use a monochrome Antigravity icon that matches the other agent icons
...
- Avoid treating Antigravity's transient startup sign-in message as an authentication failure
