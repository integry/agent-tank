...
// Tank logo icon for Agent Tank branding - minimalist U-shaped vertical tank
const tankIcon = `<svg class="tank-logo" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 4v12a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4V4"/>
  <line x1="6" y1="4" x2="18" y2="4"/>
  <line x1="8" y1="8" x2="16" y2="8" opacity="0.3"/>
...
const agentIcons = {
  ...
  agy: `<svg class="agent-icon" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label="Antigravity">
